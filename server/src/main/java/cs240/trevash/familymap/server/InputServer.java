package cs240.trevash.familymap.server;
...
import cs240.trevash.familymap.server.Handlers.*;

/**
 * InputServer function STARTING THE PROGRAM!!
 */
public class InputServer {
    ...
    // an HTTP InputServer in any Java program.
    ...
    // The "InputServer" field contains the HttpServer instance for this program,
    // which is initialized in the "run" method below.
    private HttpServer server;

    // This method initializes and runs the InputServer.
    // The "portNumber" parameter specifies the port number on which the
    // InputServer should accept incoming client connections.
    private void run(String portNumber) {

        // Since the InputServer has no "user interface", it should display "log"
        ...
        // inside the InputServer, which can be useful for diagnosing problems
        // that may occur.
        System.out.println("Initializing HTTP InputServer");
        ...
        // Log message indicating that the InputServer is creating and installing
        // its HTTP handlers.
        ...
        System.out.println("Starting InputServer");
        ...
        // Log message indicating that the InputServer has successfully started.
        System.out.println("InputServer started");
    }

    public static void main(String[] args) {
        String portNumber = args[0];
        new InputServer().run(portNumber);
    }
}
